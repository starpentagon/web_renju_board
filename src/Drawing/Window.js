...
CDrawingAboutWindow.prototype.private_InitKeyBoardShortcutsPage = function(oDiv, oPr)
{
    ...
    this.private_AppendTableCommonString(oTBody, {CtrlKey : true,  KeyCode : 86, ShiftKey : false }, "Open Sgf",                          "Ctrl+V",                                  "Open the Sgf data from clipboard. (Not in color mode, see below)");
    this.private_AppendTableCommonString(oTBody, {CtrlKey : true,  KeyCode : 78, ShiftKey : true}, "Create new",                        "Ctrl+Shift+N",                                        "Create new empty board. (not in color mode see below)");
    ...
    this.private_AppendTableCommonString(oTBody, {CtrlKey : false,  KeyCode : 86, ShiftKey : true}, "View mode change of the next move", "Shift+V",                                       "There are 3 mods: Show all next move variants, show all alternative variants of the current move, show nothing.");
